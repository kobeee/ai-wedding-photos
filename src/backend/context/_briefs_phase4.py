...
_BRIEF_FRENCH = CreativeBrief(
    ...
    variants=[
        ...
        PromptVariant(
            ...
            solo_bride_intent="She leans into centuries of stone and her own quiet joy",
            solo_bride_action="The bride leaning against a sun-warmed limestone wall, one hand tracing the old stone, a soft private smile, lavender sprig in her other hand",
            solo_bride_emotion="Self-contained warmth — she doesn't need anyone to complete this moment",
        ),
        PromptVariant(
            id="french_bridge",
...
_BRIEF_MINIMAL = CreativeBrief(
    ...
    variants=[
        PromptVariant(
            ...
            framing="wide",
            action="Full-body silhouette against a bright seamless backdrop, leaning toward each other, fingertips inches apart, the tension between their almost-touching hands telling the whole story",
        ...
        PromptVariant(
            ...
            solo_groom_intent="One man, one light, nothing to hide behind",
            solo_groom_action="The groom in sharp profile, geometric light stripe cutting across his jaw and collar, eyes forward with quiet intensity, grey seamless backdrop",
            solo_groom_emotion="Stripped-back confidence — no props, no pose, just presence",
        ),
        PromptVariant(
...
_BRIEF_ONSEN = CreativeBrief(
    ...
    variants=[
        PromptVariant(
            ...
            framing="wide",
            action="Walking along a mossy stone path under a canopy of red maples, her hand resting in the crook of his arm, her kimono trailing on wet stone",
...
_BRIEF_STARCAMP = CreativeBrief(
    ...
    variants=[
        PromptVariant(
            ...
            framing="wide",
            action="On a rock outcrop under the Milky Way, her head resting on his shoulder, his arm pulling her close, silhouettes backlit by the amber tent glow behind them",
        ...
        PromptVariant(
            ...
            solo_bride_intent="She dances alone and the desert watches",
            solo_bride_action="The bride spinning barefoot under a canopy of string lights, arms outstretched, bohemian dress catching warm light, sand between her toes",
            solo_bride_emotion="Wild grace — she is her own celebration, no audience required",
        ),
        PromptVariant(
            id="star_dawn",
...
_BRIEF_CHINESE_CLASSIC = CreativeBrief(
    ...
    variants=[
        PromptVariant(
            ...
            framing="wide",
            action="Walking through a moon gate into a lantern-lit courtyard, his hand guiding hers forward, red silk trailing behind her",
...
_BRIEF_WESTERN_ROMANTIC = CreativeBrief(
    ...
    variants=[
        PromptVariant(
            ...
            framing="wide",
            action="Standing at the chapel entrance, his fingers lacing through hers, golden light pouring through the doorway behind them, veil catching the glow",
...
_BRIEF_ARTISTIC_FANTASY = CreativeBrief(
    ...
    variants=[
        PromptVariant(
            ...
            framing="wide",
            action="Standing in a moonlit forest clearing, her back against his chest and his arms wrapped gently around her, bioluminescent flowers blooming at their feet, fireflies orbiting them",
        ...
        PromptVariant(
            ...
            solo_groom_intent="A knight at rest in an enchanted wood",
            solo_groom_action="The groom standing beneath a canopy of bioluminescent vines, face lit by soft otherworldly glow, looking upward with quiet wonder, velvet coat catching tiny reflected lights",
            solo_groom_emotion="Solitary awe — he has wandered into something beautiful and is not afraid",
        ),
        PromptVariant(
            id="fantasy_path",
...
_BRIEF_TRAVEL_DESTINATION = CreativeBrief(
    ...
    variants=[
        ...
        PromptVariant(
            ...
            solo_bride_intent="She descends into golden light like the island made these steps just for her",
            solo_bride_action="The bride descending narrow whitewashed steps, one hand trailing the blue railing, looking back over her shoulder with a playful grin, golden light painting the walls behind her",
            solo_bride_emotion="Effortless joy — the Mediterranean suits her and she knows it",
        ),
        PromptVariant(
            id="travel_sunset",
